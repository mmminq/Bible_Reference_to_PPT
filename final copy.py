...
12. 시 119:58
13. 시 119:64
14. <인용구> 크리스토퍼 애쉬, “여호와를 경외하는 자들을 적대하는 수많은 악인들이 이 땅에 있다 해도 주의 언약적 사랑이 미치지 않는 곳에 성도가 있기란 불가능하다. … 우리는 하나님이 사탄에게 창조세계의 일부를 넘겨주실까 두려워한다. 하지만 하나님은 그런 분이 아니다. 창조세계의 단 한 뼘도 사탄의 것이 아니다. 전 세계 구석구석은 백성을 향한 하나님의 언약적 사랑으로 충만하다. 아무리 높이 올라가거나 낮게 내려가도 여전히 하나님은 우리 곁에 함께 계신다(시 139편). … 세상은 주의 언약적 사랑으로 가득하다.”
15. <인용구> 찰스 브리지스, “여기에 그리스도인의 정체성의 요점이 있습니다. ‘주님을 자기의 분깃’으로 삼고 ‘주님의 말씀을 자기의 법칙’으로 삼는 것이 바로 그것입니다. … 주 하나님께서 주신 거룩한 소원마다 주 하나님을 섬기는 일로 그 정체성을 드러냅니다. 우리가 어떤 사람이든 어떤 소유를 가지고 있든 모든 것이 다 주님의 것입니다. 우리는 기꺼이 주님께서 우리의 모든 것을 다 주장할 권세를 가지셨음을 기쁘게 인정하며, 모든 것을 주님의 일에 사용되도록 기꺼이 드립니다. 그렇게 함으로써 우리가 주님의 구원에 동참함을 증거합니다. … 자신에게 물어보시기 바랍니다. 하나님을 이렇게 분깃으로 선택하는데 신중하게 생각하고 조금도 미련없이 자원하는 마음으로 한 일인가? 이런 결정을 후회하지 않고 계속 존중하며 견지할 것을 결심하였는가? 죽음이 올지라도 하나님을 분깃으로 삼는 이 즐거움에서 나를 떼어내지 못하게 할 것이라고 결심했는가? 내가 진정 하나님을 구주로뿐만 아니라 주권자로도 받아 기꺼이 모시고 있는가?”
"""
...
parsed = parse_scripture_file('ESV-text/ESV_cleaned.txt')
